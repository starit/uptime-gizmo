...
| [`uptime-gizmo-sync`](https://github.com/starit/uptime-gizmo/blob/main/skills/uptime-gizmo-sync/SKILL.md) | 1.0.3 | Create and update monitors (and tags). No delete |
